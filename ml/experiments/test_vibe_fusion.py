...
def test_build_and_forward():
    ...
    from ml.experiments.vibe_fusion.model import NUM_VIBES, PERCEPTUAL_DIM, build_vibe_fusion, dummy_batch
...
def test_presence_mask_zeros_audio():
    ...
    from ml.experiments.vibe_fusion.model import AUDIO_DIM, build_vibe_fusion
...
def test_export_refuses_missing_weights(tmp_path):
    from ml.experiments.vibe_fusion.export import export
...
def test_export_refuses_overwrite(tmp_path):
    ...
    from ml.experiments.vibe_fusion.export import export
    from ml.experiments.vibe_fusion.model import build_vibe_fusion, dummy_batch
...
def test_vibe_labels_count():
    from ml.experiments.vibe_fusion.model import NUM_VIBES, VIBE_LABELS
...
def test_experiments_moe_is_marked():
    ...
    moe = ROOT / "ml/experiments/moe_kickstart.py"
    assert moe.is_file()
